...
//
//// INIT stuff
//const float PADDLE_SCALE = 3.0f;
//
//const glm::vec3 PADDLE_1_INIT_POS = glm::vec3(-5.0f, 0.0f, 0.0f),
//                PADDLE_1_DIM      = glm::vec3( 1.0f, 1.0f * PADDLE_SCALE, 0.0f),
//                PADDLE_2_INIT_POS = glm::vec3( 5.0f, 0.0f, 0.0f),
//                PADDLE_2_DIM      = glm::vec3( 1.0f, 1.0f * PADDLE_SCALE, 0.0f),
//                BALL_INIT_POS     = glm::vec3(0.0f, 0.0f, 0.0f),
//                BALL_DIM          = glm::vec3(1.0f, 1.0f, 0.0f);
//
